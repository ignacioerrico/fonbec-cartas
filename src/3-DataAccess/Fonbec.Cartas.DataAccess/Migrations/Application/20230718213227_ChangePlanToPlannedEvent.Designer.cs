...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230718213227_ChangePlanToPlannedEvent")]
    partial class ChangePlanToPlannedEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 7, 18, 21, 32, 27, 44, DateTimeKind.Unspecified).AddTicks(2557), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });
