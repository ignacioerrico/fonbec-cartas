...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230601182032_AddBecario")]
    partial class AddBecario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 6, 1, 18, 20, 31, 934, DateTimeKind.Unspecified).AddTicks(1195), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });
