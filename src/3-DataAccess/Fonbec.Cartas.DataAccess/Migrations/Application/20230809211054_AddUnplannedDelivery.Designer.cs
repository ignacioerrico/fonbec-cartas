...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230809211054_AddUnplannedDelivery")]
    partial class AddUnplannedDelivery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 8, 9, 21, 10, 53, 662, DateTimeKind.Unspecified).AddTicks(1797), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Planning.UnplannedDelivery", b =>
                {
                    ...
                    b.ToTable("UnplannedDeliveries", "model");
                });
