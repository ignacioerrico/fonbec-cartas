...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230726035813_AddUrlGuidToApadrinamiento")]
    partial class AddUrlGuidToApadrinamiento
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 7, 26, 3, 58, 12, 676, DateTimeKind.Unspecified).AddTicks(6364), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });
