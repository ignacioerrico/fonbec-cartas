...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230808165037_SeparatePlannedEventAndDeadline")]
    partial class SeparatePlannedEventAndDeadline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 8, 8, 16, 50, 37, 4, DateTimeKind.Unspecified).AddTicks(3585), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });

            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Planning.Deadline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Planning.UnplannedDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnplannedDelivery", "model");
                });
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Planning.UnplannedDelivery", b =>
                {
                    ...
                    b.HasOne("Fonbec.Cartas.DataAccess.Entities.Planning.Deadline", "Deadline")
                        .WithMany("UnplannedDeliveries")
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Planning.Deadline", b =>
                {
                    b.Navigation("UnplannedDeliveries");
                });
