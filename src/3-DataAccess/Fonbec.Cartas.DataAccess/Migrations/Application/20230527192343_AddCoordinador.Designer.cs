...
namespace Fonbec.Cartas.DataAccess.Migrations.Application
{
    ...
    [Migration("20230527192343_AddCoordinador")]
            ...
            modelBuilder.Entity("Fonbec.Cartas.DataAccess.Entities.Filial", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOnUtc = new DateTimeOffset(new DateTime(2023, 5, 27, 19, 23, 43, 19, DateTimeKind.Unspecified).AddTicks(6995), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Default"
                        });
                });
